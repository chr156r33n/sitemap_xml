...
def process_sitemap(url, user_agent, timeout=10):
    results = []
    ...
    if sitemap_tags:
        for sitemap_tag in sitemap_tags:
            ...
            results.extend(process_sitemap(nested_sitemap_url, user_agent, timeout))
    else:
        for loc in soup.find_all('loc'):
            ...
            try:
                ...
                if response_code == 200:
                    page_response = requests.get(url, headers={'User-Agent': user_agent}, timeout=timeout)
